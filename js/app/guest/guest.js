...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Danial & Izzati serta Haikal & Munirah',
            dates: `${formatDate('2026-09-05 11:00')}/${formatDate('2026-09-05 16:00')}`,
            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
            location: 'WanKay Suite Stay & Event Space,28870, Jalan Gong Badak, Kampung Gong Badak, 21300 Kuala Terengganu, Terengganu',
            ctz: config.get('tz'),
        });
